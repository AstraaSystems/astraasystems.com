...
def logo_small():
    if LOGO_PNG.exists():
        return '<img src="/assets/company_logo.png" alt="Astraa logo">'
    if LOGO_SVG.exists():
        return '<img src="/assets/company_logo.svg" alt="Astraa logo">'
    return '<div class="logo">A</div>'

def logo_header():
    if HEADER_PNG.exists():
        return '<img class="hero-logo" src="/assets/company_logo_header.png" alt="Astraa logo">'
    if LOGO_PNG.exists():
        return '<img class="hero-logo" src="/assets/company_logo.png" alt="Astraa logo">'
    if LOGO_SVG.exists():
        return '<img class="hero-logo" src="/assets/company_logo.svg" alt="Astraa logo">'
    return ""
