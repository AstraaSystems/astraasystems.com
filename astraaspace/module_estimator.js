// Astraa Estimator — construction, enterprise engine + assemblies + BC dropdown
var EstimatorModule = {
  bcCities: [
    "BC / Vancouver","BC / Burnaby","BC / Richmond","BC / Surrey","BC / Coquitlam",
    "BC / Port Coquitlam","BC / Port Moody","BC / New Westminster","BC / North Vancouver",
    "BC / West Vancouver","BC / Delta","BC / Langley","BC / Maple Ridge","BC / Pitt Meadows",
    "BC / White Rock","BC / Abbotsford","BC / Chilliwack","BC / Mission","BC / Hope",
    "BC / Victoria","BC / Saanich","BC / Langford","BC / Colwood","BC / Nanaimo","BC / Parksville",
    "BC / Qualicum Beach","BC / Duncan","BC / Courtenay","BC / Comox","BC / Campbell River",
    "BC / Port Alberni","BC / Tofino","BC / Ucluelet","BC / Powell River","BC / Squamish",
    "BC / Whistler","BC / Pemberton","BC / Gibsons","BC / Sechelt","BC / Kelowna","BC / West Kelowna",
    "BC / Vernon","BC / Penticton","BC / Kamloops","BC / Merritt","BC / Salmon Arm","BC / Revelstoke",
    "BC / Cranbrook","BC / Kimberley","BC / Fernie","BC / Nelson","BC / Castlegar","BC / Trail",
    "BC / Golden","BC / Prince George","BC / Quesnel","BC / Williams Lake","BC / Fort St. John",
    "BC / Dawson Creek","BC / Terrace","BC / Prince Rupert","BC / Kitimat","BC / Smithers",
    "BC / Fort Nelson","BC / Other City or Town"
  ],
  ...
  render: function () {
    ...
    return ''
      ...
      + '<p style="color:#64748b;margin-bottom:16px;">Enter project details to generate a calibrated estimate.</p>'
      ...
      + '  <button onclick="EstimatorModule.run()" style="padding:12px;border:none;border-radius:8px;background:#1d4ed8;color:#fff;font-weight:700;cursor:pointer;">Generate Estimate</button>'
      + '</div>'
  ...
  run: function () {
    ...
    fetch(this.apiBase() + "/api/estimate/enterprise", {
      method: "POST",
      headers: {
    ...
    .then(function (data) {
      if (data.success && data.estimate) {
        ...
        out.innerHTML = "<p style='color:#dc2626;'>" + (data.error || 'Estimate failed.') + "</p>";
      }
    })
    .catch(function (e) {
      out.innerHTML = "<p style='color:#dc2626;'>Connection error: " + e.message + "</p>";
    });
  }
};
