...
var ProjectDocModule = {
  ...
  render:function(){
    ...
    document.getElementById('est_result').innerHTML =
      ...
      + "<strong>Disclaimer:</strong> This document is a cost estimate prepared for budgeting and planning purposes. It should be reviewed by a qualified professional and verified against current supplier and labour costs before being used for bidding or contracting. Actual project costs may vary."
      + "</div>"
